  ...
  <div class="post d-flex flex-column-fluid" id="kt_post">
      ...
      <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card text-center">
          <div class="card-body">
            <a href="{{ route('datapengiriman.index')}}" class="btn btn-primary">Kembali</a>
            <a href="{{ route('datapengiriman.print',$cargo->id) }}" target="blank" class="btn btn-primary" type="button">Print</a>
