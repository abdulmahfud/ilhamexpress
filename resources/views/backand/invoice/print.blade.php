...
<head>
    ...
    <title>{{ $invoice->date }}-{{ $invoice->client->nama_lengkap }}</title>
...
<body class="card">
    ...
    <header>
        ...
        <div class="float-right">
            ...
            <h3 class="p-1">No Invoice: {{ $invoice->id }}</h3>
            <p class="p-1">Nama : {{ $invoice->client->nama_lengkap }}
            <p>
                <span class="p-1">Jatuh Tempo: {{ $invoice->due_date }}</span>
        </div>
    </header>
    ...
    <section class="card items">
        ...
        <div class="row contents">
            ...
            <div class="col-1-10 text-center">
                @currency($record->harga)
            </div>
            <div class="col-1-10 text-center">
                @currency($record->sub_total)
        ...
        <div class="row">
            ...
            <div class="col-1-10 text-center">
                @currency($invoice->total_bayar)
            </div>
        </div>
    </section>
    <div class="line-bottom ">
    </div>
    <h6><p>Ket: {{ $invoice->keterangan }}</p></h6>
    <div class="float-right">
