    ...
    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
        ...
        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
            ...
            <div class="menu-item">
                ...
                <a class="menu-link active" href="{{ url('home2')}}">
                    <span class="menu-icon">
                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                        <span class="svg-icon svg-icon-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <a class="menu-link active" href="{{ url('home3')}}">
                    <span class="menu-icon">
                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                        <span class="svg-icon svg-icon-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <div data-kt-menu-trigger="click" class="menu-item @if(url()->current() == route('cargo.updatePosisi') ||  url()->current() == route('tarif.index') ) here show @else @endif menu-accordion">
                <span class="menu-link">
                    <span class="menu-icon">
                    ...
                    <span class="menu-title">1. Pengiriman Lokal</span>
                    <span class="menu-arrow"></span>
                </span>
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
                        <a class="menu-link @if(url()->current() == route('origin.index')) active @else @endif" href="{{ route('origin.index')}}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link @if(url()->current() == route('datapengiriman.index')) active @else @endif" href="{{ route('datapengiriman.index')}}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
            ...
            <div data-kt-menu-trigger="click" class="menu-item @if(url()->current() == route('manifest.index') ||  url()->current() == route('manifest.create') ) here show @else @endif menu-accordion">
                <span class="menu-link">
                    ...
                    <span class="menu-title">Manifest Pengiriman Lokal</span>
                    <span class="menu-arrow"></span>
                </span>
                <div class="menu-sub menu-sub-accordion">
            ...
            <div data-kt-menu-trigger="click" class="menu-item @if(url()->current() == route('tarif-rajao.index') ||  url()->current() == route('pengiriman-rajao.index') ) here show @else @endif menu-accordion">
                <span class="menu-link">
                    <span class="menu-icon">
                        <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm002.svg-->
                        <span class="svg-icon svg-icon-2">
                    ...
                    <span class="menu-title">2. Pengiriman Pihak Ketiga</span>
                    <span class="menu-arrow"></span>
                </span>
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
                        <a class="menu-link @if(url()->current() == route('tarif-rajao.index')) active @else @endif" href="{{ route('tarif-rajao.index')}}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link @if(url()->current() == route('pengiriman-rajao.index')) active @else @endif" href="{{ route('pengiriman-rajao.index')}}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Input Pengiriman </span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link @if(url()->current() == route('pengiriman-rajao-tracking.index')) active @else @endif" href="{{ route('pengiriman-rajao-tracking.index')}}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Update Posisi</span>
            ...
            <div data-kt-menu-trigger="click" class="menu-item @if(url()->current() == route('origin.index') ||  url()->current() == route('typepaket.index') ) here show @else @endif menu-accordion">
                <span class="menu-link">
                    <span class="menu-icon">
                        <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm002.svg-->
                        <span class="svg-icon svg-icon-2">
                    ...
                    <span class="menu-title">3. Pengiriman Trackingmore</span>
                    <span class="menu-arrow"></span>
                </span>
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
                    ...
                    <div class="menu-item">
                        <a class="menu-link @if(url()->current() == route('typepaket.index')) active @else @endif" href="{{ route('typepaket.index')}}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link @if(url()->current() == route('country.index')) active @else @endif" href="{{ route('country.index')}}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link @if(url()->current() == route('tarifin.index')) active @else @endif" href="{{ route('tarifin.index')}}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Tarif Trakingmore</span>
                        </a>
                    </div>
                   
                    <div class="menu-item">
                        <a class="menu-link @if(url()->current() == route('pengiriman-trakingmore.index')) active @else @endif" href="{{ route('pengiriman-trakingmore.index')}}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Input Pengiriman</span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link @if(url()->current() == route('cek-trakingmore.tracking')) active @else @endif" href="{{ route('cek-trakingmore.tracking')}}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Lacak Pengiriman</span>
