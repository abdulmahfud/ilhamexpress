    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                ...
                <!--end::Separator-->
                <!--begin::Description-->
                <small class="text-muted fs-7 fw-bold my-1 ms-1">tarif-rajao</small>
                <!--end::Description--></h1>
                <!--end::Title-->
            </div>
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                     <a href="{{ route('tarif-rajao.index')}}" class="btn btn-primary">Kembali</a>
                                </div>
                            </div>
                            <!--end::Card toolbar-->
                        </div>
                        ...
                        {!! Form::open(array('route' => 'tarif-rajao.store','method'=>'POST','enctype'=>"multipart/form-data")) !!}
                             @csrf
            ...
            <button class="btn btn-md btn-primary">Simpan Tarif</button>
                ...
                success: function (response) {
                    ...
                    if (response) {
                        ...
                        $.each(response ['costs'], function (key, value) {
                            $('#ongkir').append('<li class="list-group-item">'+response.code.toUpperCase()+' : <strong>'+response.name+'<br>layanan' +value.service[0]+'Rp.'+value.cost[0].value+'('+value.cost[0].etd+' hari)</strong>' )
                        });
                    }
                }
            });
