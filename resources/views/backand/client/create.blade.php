                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::text('nama', null, array('placeholder' => 'nama_lengkap','class' => 'form-control')) !!}
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <select class="my-select2 form-select province_penerima" name="nama_provinsi" id="provinsi_penerima" data-placeholder="Select an option" required>
                            </select>
                          </div>
                        </div>
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <select class="my-select2 cities_penerima form-select" name="nama_kabupaten" id="kota_penerima"data-control="select2" data-placeholder="Select an option" required>
                            </select>
                          </div>
                        </div>
                      </div>
                      <div class="row mb-3">
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <select class="my-select2 districts_penerima form-select" name="nama_kecamatan" id="kecamatan_penerima"data-control="select2" data-placeholder="Select an option" required>
                            </select>
                          </div>
                        </div>
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <select class="my-select2 vilages_penerima form-select" name="nama_desa" id="desa_penerima"data-control="select2" data-placeholder="Select an option" required>
                            </select>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="number" name="no_hp" value="+62" class="form-control">
                        </div>
                    </div>
