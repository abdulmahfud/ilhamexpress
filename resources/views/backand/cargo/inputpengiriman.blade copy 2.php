              ...
              <div class="card">
                ...
                <div class="card-body" >
                    ...
                    <!--end::Nav-->
											<!--end::Nav-->
											<!--begin::Form-->
											<form class="mx-auto fs-6 gy-5 zero-padd-horizon" method="POST" action={{ route('cargo.savePengiriman')}} novalidate="novalidate" id="kt_create_account_form">
												<!--begin::Step 1-->
                              ...
                              <div class="row">
                                <div class="col-4">
                                  <div class="row mb-3">
                                    <div class="form-group">
                                      <strong>Nama Pengirim <label class="required fs-6"></label></strong>
                                      {!! Form::text('nama_pengirim', old('nama_pengirim'), array('placeholder' => 'nama_pengirim','class' => 'form-control', 'id' =>'nama_pengirim')) !!}
                                    </div>
                                  </div>
                                  <div class="row mb-3">
                                    <div class="form-group">
                                      <strong>Company <label class="required fw-bold fs-6"></label></strong>
                                      {!! Form::text('nama_perusahaan_pengirim', old('nama_perusahaan_pengirim'), array('placeholder' => 'company','class' => 'form-control')) !!}
                                    </div>
                                  </div>
                                  <div class="row mb-3">
                                    <div class="form-group">
                                ...
                                <div class="col-8">
                                  <div class="row mb-3 pt-5 pb-5">
                                    <div class="form-group">
                                      <strong>Alamat Pengirim <label class="required fs-6"></label></strong>
                              ...
                              <div class="fv-row">
                                <div class="row">
                                  <div class="col-4">
                                    ...
                                    <div class="row mb-3">
                                      <div class="form-group">
                                        <strong>Company <label class="required fs-6"></label></strong>
                                        {!! Form::text('nama_perusahaan_penerima', old('nama_perusahaan_penerima'), array('placeholder' => 'company','class' => 'form-control')) !!}
                                      </div>
                                    </div>
                                    <div class="row mb-3">
                                      <div class="form-group">
                                    ...
                                    <div class="row mb-3">
                                      <div class="form-group">
                                        <strong>Telepon <label class="required fs-6"></label></strong>
                                        {!! Form::text('no_hp_penerima', old('no_hp_penerima'), array('placeholder' => 'telepon','class' => 'form-control')) !!}
                                      </div>
                                    </div>
                                  </div>
                                  <div class="col-8">
                            ...
                            <div class="fv-row mb-10">
                              <div class="row">
                                ...
                                <div class="col-4">
                                  ...
                                  <div class="row mb-3">
                                      <div class="form-group">
                                        <strong>Harga Barang <label class="required fs-6"></label></strong>
                                        {!! Form::number('harga_barang', old('harga_barang'), array('placeholder' => 'harga barang','class' => 'form-control', 'id' =>'harga_barang')) !!}
                                      </div>
                                    </div>
                                  <div class="row mt-10">
                                ...
                                <div class="col-4">
                                  <div class="row mb-3 pt-5 pb-5">
                                    <div class="form-group">
                                      ...
                                      <textarea class="form-control form-control-solid" rows="3" name="keterangan" placeholder="Keterangan Isi Paket" style="height: 115px;"></textarea>
                                    </div>
                                  </div>
                                  {{-- <div class="row mb-3">
                                    <div class="col-5">
