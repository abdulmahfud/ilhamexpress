    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <div class="card">
                ...
                {!! Form::open(array('route' => 'tarif.store','method'=>'POST','enctype'=>"multipart/form-data")) !!}
                     @csrf
                <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                          <label for="tbxStart">Start (gram)</label>
                          <input class="form-control" type="number" name="min_kg">
                        </div>
                        <div class="form-group col-6">
                          <label for="tbxEnd">End (gram)</label>
                          <input class="form-control" type="number" name="max_kg">
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>tarif:</strong>
                            <input type="text" class="form-control form-control-solid mb-2" onkeyup="convertToRupiah(this)" name="tarif" placeholder="tarif" />
                        </div>
                    </div>
