            ...
            <div class="">
              <div class="row">
                ...
                <div class="col-lg-10 offset-lg-1">
                  <h3 class="align-center">Posisi Pengiriman Anda!</h3>
                   <table class="table">
                     <thead>
                       <tr>
                        <th class="min-w-125px">no_resi</th>
                     ...
                     <tbody>
                       ...
                       <tr>
                        <td>{{ $tarif->no_resi}}  </td>
                        <td>{{ $tarif->catatan}}{{ $tarif->keterangan}} </td>
                        <td>{{ $tarif->status}}{{ $tarif->status_pengiriman}} </td>
                     </tr>
                       @empty
                           <div class="alert alert-warning alert-dismissible fade show" role="alert">
                             <strong>Tidak Ditemukan Resi</strong>
                           </div>
                       @endforelse
                     </tbody>
                   </table>
                </div>
                <a href="{{url('tracking')}}" type="button" class="btn btn-primary">Tracking</a>
              </div>
            </div>
          </div>
        </div>
