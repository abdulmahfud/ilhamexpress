      ...
      <div id="kt_content_container" class="container-xxl">
                ...
                <div class="col-md-10">
                    <div class="receipt bg-white p-3 rounded"><img src="{{ asset('assets/logo.png')}}" width="120">
                        ...
                        <div class="d-flex flex-row justify-content-between align-items-center order-details">
                            ...
                            <div><span class="d-block fs-12">Service Pengiriman</span><span class="font-weight-bold text-success">{{$cargo->courier}}</span></div>
            </div>
                        <hr>
        ...
        <div class="card text-center">
          <div class="card-body">
            ...
            <a href="{{ route('pengiriman-rajao.print',$cargo->id) }}" target="blank" class="btn btn-primary" type="button">Print</a>
