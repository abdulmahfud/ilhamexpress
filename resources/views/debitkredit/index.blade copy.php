                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <form action="{{ route('debitkredit.index')}}" method="GET">
                            <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search debitkredit" name="search"/>
                            </form>
                        </div>
                        <!--end::Search-->
                    </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="table-debitkredit">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Jenis Saldo</th>
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                ...
                                <td>{{ $debitkredit->jenis_akun->nama_akun }}</td>
                                <td>{{ $debitkredit->tgl_input }} </td>
                                <td>{{ $debitkredit->jenis_saldo }} </td>
                                <td>Rp. {{number_format($debitkredit->saldo ,2,',','.')}} </td>
