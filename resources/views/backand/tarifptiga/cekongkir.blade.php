                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control kurir" name="courier">
                            ...
                            <option value="anterinaja">ANTERAJA</option>
                ...
                success: function (response) {
                    ...
                    if (response) {
                        ...
                        $.each(response ['costs'], function (key, value) {
                            $('#ongkir').append('<li class="list-group-item">'+response.code.toUpperCase()+' : <strong>'+response.name +value.service[0]+value.cost[0].value+'('+value.cost[0].etd+' hari)</strong>' )
                        });
