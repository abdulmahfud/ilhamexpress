                ...
                <!--begin::Card title-->
                  ...
                  <div class="card-toolbar">
                      ...
                      <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                          <!--begin::Add user-->
                           <a href="{{ route('typepaket.create')}}" class="btn btn-primary">Tambah typepaket</a>
                      </div>
                  </div>
                  <!--end::Card toolbar-->
              </div>
              ...
              <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" >
                  ...
                  <tbody class="text-gray-600 fw-bold" id="myTable">
                    <!--begin::Table row-->
                    @foreach ($data as $key => $typepaket)

                    <tr>
                        <td>{{ $loop->iteration}}</td>
                        <td> 
                           {{ $typepaket->paket_name }}
                        </td>
                      </td>
                        <td class="text-end">
                          ...
                          <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                              <a href="{{ route('typepaket.edit',$typepaket->id) }}" class="menu-link px-3">Edit</a>
                            </div>
                            @endcan
                            @can('typepaket')
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                              <a href="{{ route('typepaket.delete',$typepaket->id) }}" class="menu-link px-3" data-kt-users-table-filter="delete_row" id="delete-confirm">Delete</a>
                            </div>
                            <!--end::Menu item-->
                            @endcan
